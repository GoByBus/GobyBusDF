...
public class MapsActivity extends FragmentActivity  implements OnMapReadyCallback,
    ...
    private LatLng mDummyLatLng = new LatLng(-15.7882292, -47.9005925);
    ...
    private String ImageUrl = "https://maps.google.com/mapfiles/kml/shapes/bus.png";
    ...
    private void initViews() {
        ...
        mMarkerImageView = (ImageView) mCustomMarkerView.findViewById(R.id.map);
        ...
        Glide.with(getApplicationContext()).
                ...
                .into(new SimpleTarget<Bitmap>() {
                    ...
                    public void onResourceReady(Bitmap bitmap, GlideAnimation<? super Bitmap> glideAnimation) {
                        ...
                        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(mDummyLatLng, 13f));
